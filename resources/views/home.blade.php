...
<section class="hero"> 
    <div class="hero-content">
		<div class="container">
			<h1 class = "hero-title"> @lang("Ingeniero informático, programador freelance") </h1>
...
<section id="mensajes" class="background">
    ...
    <div class="container">
		<div class="row section-title">
			<div class="col-12">
				<h2>Jose Carlos Román
					<br>
					<span>@lang("Tu proyecto en las mejores manos")</span>
				</h2>
    ...
    <div class="container">
        <div class="row justify-content-center">
			<div class="col section-title">
				<h2> @lang("¿Por qué contratar a un <span>freelancer</span>?") </h2>
			</div>
		</div>
