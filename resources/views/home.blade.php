...
<section id="mensajes" class="background">
    ...
    <div class="container">
		<div class="row section-title">
			<div class="col-12">
				<h2>
					@lang("Tu proyecto <span>en las mejores manos</span>")
				</h2>
...
<section id="jc-overview">
	<div class="container">
		<div class="row row-content justify-content-center">
			<div class="text-center">
				<img src="{{ asset('storage/images/JC.jpg') }}" alt="Jose Carlos Román Rubio" class="rounded-circle">
