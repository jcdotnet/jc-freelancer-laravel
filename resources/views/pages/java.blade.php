...
<section id="java-lcc-uma" class="background">
   <div class="container">
	    <div class="row">
		    <div class="col mt-3 section-subtitle">
		       <h2 class="center"> @lang("Programación Orientada a Objetos ")(Universidad de Málaga)</h2>
			</div>
	    </div>
...
<section id="java-forman">
    <div class="container">
		<div class="row">
		    <div class="col mt-3 section-subtitle">
		       <h2 class="center"> @lang("Desarrollo de aplicaciones con J2EE ")(Forman, P.T.A. Málaga)</h2> 
			</div>
	    </div>		
        <div class="row row-content">           
            <div class="col-12 size-xl"> 
...
<section id="java-books" class="background">
    <div class="container">
		<div class="row">
		    <div class="col mt-3 section-subtitle">
		       <h2 class="center"> @lang('Libros')</h2>
			</div>
