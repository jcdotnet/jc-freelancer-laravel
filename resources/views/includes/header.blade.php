		...
		<div class="row" id="top-bar">	
			<div class="col">
				...
				<div class="pull-right">
					<a class="language" data-locale="en" class="flag"><img src="{{ asset("images/en_UK.png") }}" width="25"> </a>
					<a class="language" data-locale="es" class="flag"><img  src="{{ asset("images/es_ES.png") }}" width="25"></a> 
				</div> 
			</div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbar-items">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item">
						<a class="nav-link" href="{{ route('home') }}"> @lang("Inicio") </a></li>
					...
					<li class="nav-item {{Request::is('about*') ? 'active':''}}"><a class="nav-link" href="{{ route('about') }}"> @lang('Sobre mí') </a></li> 
					<li class="nav-item {{Request::is('contacto') ? 'active':''}}"><a class="nav-link" href="{{ route('contact') }}"> @lang('Contacto')</a></li>                    
				</ul>
			</div>
		</div>
	</nav>
