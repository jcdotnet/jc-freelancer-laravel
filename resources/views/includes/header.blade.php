<header>
	...
	<nav class="navbar navbar-toggleable-sm fixed-top">
		<div class="container">
			...
			<a href="{{ route('home', Config::get('app.locale')) }}" class="navbar-brand" ><img src=" {{ asset("images/jc_letters.png") }}"></a>
			<div class="collapse navbar-collapse" id="navbar-items">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item">
						<a class="nav-link" href="{{ route('home', Config::get('app.locale')) }}"> @lang("Inicio") </a></li>
					<li class="nav-item dropdown {{Request::is('servicios*') ? 'active':''}}">
						...
						<ul class="dropdown-menu">
							<li><a href="{{ route('servicios', [Config::get('app.locale'), __("servicios")] ) }}"> @lang("Todos mis servicios")</a></li> 
							<li><a href="http://josecarlosroman.com/wordpress/" target="_blank">WordPress</a></li>
						</ul>
					</li>
					<li class="nav-item {{Request::is('proyecto*') ? 'active':''}}"><a class="nav-link" href="{{ route('proyectos', [Config::get('app.locale'), __("routes.proyectos")]) }}"> @lang('Proyectos') </a></li> 
					<li class="nav-item {{Request::is('about*') ? 'active':''}}"><a class="nav-link" href="{{ route('about', Config::get('app.locale')) }}"> @lang('Sobre mí') </a></li> 
					<li class="nav-item {{Request::is('contacto') ? 'active':''}}"><a class="nav-link" href="{{ route('contacto', [Config::get('app.locale'), __("routes.contacto")]) }}"> @lang('Contacto')</a></li>                    
				</ul>
			</div>
		</div>
	</nav>
